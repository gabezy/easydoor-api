...
(3, 'GUEST', 'Guest user with read-only access', now());
...
(1, 'admin', 'admin@easydoor.local', '$2a$10$SlVZQbp0JY4zfVHi6mwDuOpst9/GyQ2L/PQcy/Ty1D5KwngWyOyti', true, now()),
(2, 'user', 'user@easydoor.local', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcg7b3XeKeUxWdeS86E36BCnvIm', true, now()),
(3, 'guest', 'guest@easydoor.local', '$2a$10$V3zyD9/4SBqIVP0nHHEH2OPST9/pDHYiB5wK5X3Y8Z2L9N1mKsF5m', true, now());

...
(1, 'admin', 'admin@easydoor.local', '$2a$12$lxnGAi7sMoywk4polCGMoubFj76cM596Eq./VWgQGObdcaR4qoVgS', true, now()),
(2, 'agent', 'user@easydoor.local', '$2a$12$lxnGAi7sMoywk4polCGMoubFj76cM596Eq./VWgQGObdcaR4qoVgS', true, now()),
(3, 'client', 'guest@easydoor.local', '$2a$12$lxnGAi7sMoywk4polCGMoubFj76cM596Eq./VWgQGObdcaR4qoVgS', true, now());
